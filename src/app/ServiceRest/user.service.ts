...
export class UserService {
  ...
  CreateNewUser(newUser: Users) {
    ...
    this.http
      .post<Users>("https://rest-api-immo-env.p2cntupqca.us-east-1.elasticbeanstalk.com:5000/newusers", this.user)
      .subscribe(
        () => {
  ...
  getUserFromServer(email: string) {
    const url = "https://rest-api-immo-env.p2cntupqca.us-east-1.elasticbeanstalk.com:5000/connexion/" + email;
  ...
  onInitGetUserFromServer() {
    ...
    const url = "https://rest-api-immo-env.p2cntupqca.us-east-1.elasticbeanstalk.com:5000/connexion/"+ userStoredEmail;
  ...
  SavePubIntoBase(pub: Pub) {
    const url = "https://rest-api-immo-env.p2cntupqca.us-east-1.elasticbeanstalk.com:5000/newpublication";
  ...
  getPromoteurPubFromServer(email: string) {
    const url = "https://rest-api-immo-env.p2cntupqca.us-east-1.elasticbeanstalk.com:5000/publications/"+ email;
  ...
  onInitGetPubFromServer() {
    const userStoredEmail = sessionStorage.getItem("email");
    const url = "https://rest-api-immo-env.p2cntupqca.us-east-1.elasticbeanstalk.com:5000/publications/"+ userStoredEmail;
  ...
  getSinglePubOfPromoteur(id: number) {
    const url = "https://rest-api-immo-env.p2cntupqca.us-east-1.elasticbeanstalk.com:5000/publication/"+id;
  ...
  deleteImgFromServer(respub: RespPub) {
    ...
    this.http
      .delete<RespPub>("https://rest-api-immo-env.p2cntupqca.us-east-1.elasticbeanstalk.com:5000/delete" + "/" + respub.id)
      .subscribe(
        () => {
  ...
  deleteUserInServer(user: Users) {
    ...
    this.http
      .delete<RespPub>("https://rest-api-immo-env.p2cntupqca.us-east-1.elasticbeanstalk.com:5000/deleteuser" + "/" + user.email)
      .subscribe(
        () => {
          console.log('Publication Supprimée');
          this.emitRespPubSubject();
  ...
  onInitGetAllPubFromServer() {
    const url = "https://rest-api-immo-env.p2cntupqca.us-east-1.elasticbeanstalk.com:5000/publications";
  ...
  sendMail(email: Email) {
    const url = "https://rest-api-immo-env.p2cntupqca.us-east-1.elasticbeanstalk.com:5000/send-mail";
    this.http
  ...
  getAllEmailFromServer(email: String) {
    const url = "https://rest-api-immo-env.p2cntupqca.us-east-1.elasticbeanstalk.com:5000/mesmail/" + email;
  ...
  onInitGetAllEmailFromServer() {
    const userStoredEmail = sessionStorage.getItem("email");
    const url = "https://rest-api-immo-env.p2cntupqca.us-east-1.elasticbeanstalk.com:5000/mesmail/" + userStoredEmail;
  ...
  ModifPubIntoBase(pub: Pub) {
    const url = "https://rest-api-immo-env.p2cntupqca.us-east-1.elasticbeanstalk.com:5000/modification-pub";
  ...
  ModifUserIntoBase() {
    const url = "https://rest-api-immo-env.p2cntupqca.us-east-1.elasticbeanstalk.com:5000/modification-user";
